import { z } from 'zod';
// TEMPORARY FIX: Commented out due to incompatible zod-to-openapi version
// import { extendZodWithOpenApi } from 'zod-to-openapi';

// Extend Zod with OpenAPI support
// TEMPORARY FIX: extendZodWithOpenApi(z);
...
/* TEMP: .openapi('Pagination') */

export const ApiVersionSchema = z.enum(['v1', 'v2']); /* TEMP: .openapi('ApiVersion') */
